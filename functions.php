...
?>
	<<?php echo $tag; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		?> id="comment-<?php comment_ID(); ?>" <?php comment_class('', $comment); ?>>
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			...
			<div class="comment-block">
				<footer class="comment-meta">
					...
					?>
						<em class="comment-awaiting-moderation"><?php echo $moderation_note; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
																?></em>
					<?php } ?>
				</footer>
